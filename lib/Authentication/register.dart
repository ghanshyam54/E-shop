...
class _RegisterState extends State<Register>
{
  ...
  Future <void> uploadAndSaveImage() async{
    if (_imageFile == null)
    {
      showDialog(context: context,
        builder: (c)
          {
            return ErrorAlertDialog(message: "Please uppload an image",);
          }
      );
    }
    else
      {
        _passwordTextEditingController.text == _cpasswordTextEditingController.text
            ...
            : displayDialog("password not match with Confirm password");
      }
  }
  ...
  void _registerUser() async{
    ...
    if(firebaseUser != null)
      {
        saveUserInfoToStore(firebaseUser).then((value) {
  ...
  Future saveUserInfoToStore(FirebaseUser fUser) async
  {
